...
private:
    ...
    void test_bit_grid_sizes(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid sizes ---" << RESET << std::endl;
        ...
        cellato::memory::grids::bit_planes::grid<uint8_t, bit_planes::TestStateDictionary> grid(height, width, input_grid.data());
    ...
    void test_bit_grid_pattern(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid pattern storage and retrieval ---" << RESET << std::endl;
        ...
        cellato::memory::grids::bit_planes::grid<uint8_t, bit_planes::TestStateDictionary> grid(1, 8, input_grid.data());
    ...
    void test_bit_grid_complex(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid with complex pattern ---" << RESET << std::endl;
    ...
    void test_get_cell(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid get_cell function ---" << RESET << std::endl;
    ...
    void test_to_original_representation_with_get_cell(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid to_original_representation with get_cell ---" << RESET << std::endl;
    ...
    void test_bit_grid_small_random(test_case& tc) {
        std::cout << BLUE << "\n--- Testing bit_planes_grid with small random pattern ---" << RESET << std::endl;
...
inline void register_bit_planes_grid_tests() {
    static bit_planes_grid_test_suite suite;
